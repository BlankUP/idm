...
public class IdpRequestInfo implements Serializable {
	...
	private static final long serialVersionUID = 1932497237535859148L;
			...
			public String toString() {
				return "IdpRequestInfo [requestId=" + requestId + ", serialNo=" + serialNo + ", queryseqNo="
						...
						+ ", rkDate=" + rkDate + ", rkTime=" + rkTime + ", rerunFlag=" + rerunFlag + ", messAge="
						+ messAge + "]";
			}
