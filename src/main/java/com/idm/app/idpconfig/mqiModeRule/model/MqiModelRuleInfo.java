package com.idm.app.idpconfig.mqiModeRule.model;

import java.io.Serializable;

/**
* <p>Description:模型质检模型规则实体类 </p>  
* <p>Company: </p>  
* @author pl  
* @date 2019年8月17日  
* @version 1.0
 */
public class MqiModelRuleInfo  implements Serializable {
	...
	public String toString() {
		return "MqiModelRuleInfo [mtrid=" + mtrid + ", seqno=" + seqno + ", modelcode=" + modelcode + ", modelname="
