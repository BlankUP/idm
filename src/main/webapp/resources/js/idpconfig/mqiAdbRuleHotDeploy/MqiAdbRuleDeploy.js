...
function doSearch(){
	...
	$("#grid-table").jqGrid('setGridParam', {
	    ...
	    url:root+'/mqi_adbRule_search.do',
	    datatype : "json"
	}).trigger("reloadGrid");
}
...
function queryInterfaceInfo(){
	...
	$.ajax({
        type: "post",
        url: root+'/mqi_query_adbDeploy_service.do',
...
function queryAdbfiele(){
	$.ajax({
        type: "post",
        url: root+'/mqi_queryAdbfileNameAndVerNo.do',
        datatype: "json",
        success: function(data){
...
function uploadFileSubmit(){
	...
	if($("#adbDataFrom").valid()&&iscleck){
	    ...
	    $.ajax({
	        type: "post",
	        url: root+'/mqi_get_adbVersion_forDeploy.do',
	        data:adbDataFrom, 
	        dataType: "json",
	        success: function(data){
	        	if(data.success == true) {
	        		$.ajax({ 
	        	        type:'post', 
	        	        url:root+'/mqi_add_adbDeploy_record.do', 
	        	        data:adbDataFrom,
	        	        datatype:'json',
	        			success:function(data){
	        				if(data.success == true){
