...
<body>
  <div class="container-fluid">	
	  <ul class="breadcrumb">
				...
				<li class="active"><i class="fa fa-list-alt"></i> 贷中预警模型数据统计</li>
	  </ul>
...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    <script src="<%=request.getContextPath()%>/resources/js/modelManage/modelMonitor/il_ays_data.js"></script>
