...
<body>
  <div class="container-fluid">	
	  <ul class="breadcrumb">
				...
				<li class="active"><i class="fa fa-list-alt"></i> 支用准入模型数据统计</li>
	  </ul>
	  <div class="alert alert-info">
		  <form name="searchForm" class="form-horizontal">
			  <div class="control-group">
				  <label for="ruleName" class="control-label">指标名称：</label>
				  <span class="span3">
								<input type="text" id="ruleName" placeholder="请输入指标名称...">
							</span>
...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    <script src="<%=request.getContextPath()%>/resources/js/modelManage/modelMonitor/dm_ays_data.js"></script>
