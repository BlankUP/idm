...
<body>
 <div class="container-fluid">
	 ...
	 <ul class="nav nav-tabs" id="tab-menu">
		 <li><a href="#" onclick="gopage();">网贷请求数据</a></li>
		 <li><a href="#" class="active">网贷响应数据</a></li>
	 </ul>
 ...
 <script type="text/javascript">
        ...
        function gopage() {
            location.href="<%=request.getContextPath()%>/ol_request_data_page";
        }
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datepicker.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datasourceManage/olResponseData.js"></script>
</body>
</html>