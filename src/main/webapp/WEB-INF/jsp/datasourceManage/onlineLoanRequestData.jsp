...
<body>
 <div class="container-fluid">
 	<ul class="breadcrumb">
		...
		<li class="active"><i class="fa fa-list-ol"></i> 网贷数据源</li>
	</ul>
	 <ul class="nav nav-tabs" id="tab-menu">
		 <li><a href="#" class="active">网贷请求数据</a></li>
		 <li><a href="#" onclick="gopage();">网贷响应数据</a></li>
	 </ul>
 ...
 <script type="text/javascript">
        ...
        function gopage() {
			location.href="<%=request.getContextPath()%>/ol_response_data_page";
        }
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datepicker.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datasourceManage/olRequestData.js"></script>
</body>
</html>