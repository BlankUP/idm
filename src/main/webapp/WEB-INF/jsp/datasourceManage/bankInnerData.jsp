...
<body>
 <div class="container-fluid">
 	<ul class="breadcrumb">
			...
			<li class="active"><i class="fa fa-list-ol"></i> 行内数据</li>
		</ul>
 ...
 <div id="duModal" class="modal hide fade" role="dialog" style="width:750px;">
 ...
 <script type="text/javascript">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datasourceManage/bankInnerData.js"></script>
</body>
</html>