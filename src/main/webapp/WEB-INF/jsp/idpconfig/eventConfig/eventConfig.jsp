  ...
  <ul class="breadcrumb">
	...
	<div class="alert alert-info">
            ...
            <div class="control-group">
				  <label for="searchServerId" class="control-label-5">决策点名称：</label> 
				  <span class="span3"> <input type="text" id="eventName" name="eventName" maxlength="100" placeholder="决策点名称..."></span>
				  <label for="searchName" class="control-label-4">模型名称：</label> 
...
<div id="slModal">	
	<div id="dataModal" class="modal hide fade" style="width:650px;margin-left: -335" >
		...
		<form id="dataFrom" class="form-horizontal">
						<table cellpadding="2px" >
							...
							<tr>
								<td>决策系统</td>
								<td>
									<select name="respSystemCode" id="c_respSystemCode" style="width: 404px;" onchange="getModel()">
...
<!-- 							<tr>
								<td>法人行</td>
								<td>
									<select name="orgNo" id="c_orgNo" style="width: 404px;">
									</select>
								</td>
							</tr> -->
<!-- 							<tr>
