...
<body>
  ...
  <ul class="breadcrumb">
 			...
 			<li class="active"><i class="fa fa-cog"></i> 模型质检评分规则模型</li>
  </ul>
	...
	<div id="slModal">	
	<div id="dataModal" class="modal hide fade" style="width:720px;left:45%;padding: 10px;" >
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/mqiCountAnalysis/mqiScoreRuleInfo.js"></script>
