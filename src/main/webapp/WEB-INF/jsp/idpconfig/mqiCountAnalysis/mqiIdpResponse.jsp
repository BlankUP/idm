  ...
  <ul class="breadcrumb">
		...
		<div class="alert alert-info">
            ...
            <div class="control-group">
				 ...
				 <!--  <label for="businessNo" class="control-label-4">业务流水号：</label> 
				  <span class="span3"> <input type="text" id="businessNo" maxlength="100" placeholder="系统内部业务流水号..."></span> -->
				 ...
				 <label for="productId" class="control-label-4" >产品编码：</label> 
				 <span class="span3"> <input type="text" id="productId" maxlength="100" placeholder="产品编码..."></span>
...
<div id="slModal">	
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/mqiCountAnalysis/mqiIdpResponse.js"></script>
