...
<body>
  ...
  <ul class="breadcrumb">
 			...
 			<li class="active"><i class="fa fa-list-alt"></i>模型规则配置</li>
  </ul>
  </div>
	<div class="alert alert-info">
            ...
            <div class="control-group">
			  ...
			  <div class="shangyoucanshupeizhi"><font class="shangyoucanshupeizhi-font">模型规则配置</font></div>
			</form>
	</div>	
   ...
   <!-- 导入excel后，页面展示信息 -->
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/rule/rule.js"></script>
