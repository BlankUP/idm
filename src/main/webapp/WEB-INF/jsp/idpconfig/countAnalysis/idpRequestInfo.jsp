  ...
  <ul class="breadcrumb">
	...
	<div class="alert alert-info">
            ...
            <div class="control-group">
				  <label for="serialNo" class="control-label-5">交易流水号：</label>
				  <span class="span3"> <input type="text" id="serialNo" maxlength="100" placeholder="交易流水号..."></span>
				  <label for="srcDate" class="control-label-4">申请日期：</label>
...
<div id="slModal">	
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/countAnalysis/idpRequestInfo.js"></script>
