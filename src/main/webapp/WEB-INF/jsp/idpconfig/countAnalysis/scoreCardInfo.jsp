...
<body>
  ...
  <ul class="breadcrumb">
 			...
 			<li class="active"><i class="fa fa-cog"></i> 评分卡模型</li>
  </ul>
	<div class="alert alert-info" >
            <form id="searchForm" name="searchForm" class="form-horizontal">
            <div class="control-group">
				  <label for="queryseqNo" class="control-label-5">交易流水号：</label> 
				  <span class="span2"> <input type="text" id="serialNo" maxlength="100" placeholder="交易流水号..."></span>
				   <label for="modelCode" class="control-label-4">模型编码：</label> 
				  <span class="span2"> <input type="text" id="modelCode" maxlength="100" placeholder="模型编码..."></span>
				 <label for="cifName" class="control-label-4">客户名：</label> 
				 <span class="span2"> <input type="text" id="cifName" maxlength="100" placeholder="客户名..."></span>
				<!--  <label for="idNo" class="control-label-4">证件号码：</label> 
				 ...
				 <label for="startDate" class="control-label">开始日期 : </label>
			  	 <span class="span2">
			  	 	<input type="text" class="Wdate" id="startDate" onfocus="new WdatePicker(this)"
			  	 		placeholder="请选择开始日期..." name="startDate" />
			  	 </span>
			  	 <label for="endDate" class="control-label">结束日期 : </label>
			  	 <span class="span2">
			  	 	<input type="text" class="Wdate" id="endDate" onfocus="new WdatePicker(this)" 
	...
	<div id="slModal">	
	<div id="dataModal" class="modal hide fade" style="width:1360px;left:24%;">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/countAnalysis/scoreCardInfo.js"></script>
</html>