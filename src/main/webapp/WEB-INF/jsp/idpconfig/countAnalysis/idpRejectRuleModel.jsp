...
<body>
  ...
  <ul class="breadcrumb">
	...
	<div class="alert alert-info">
            <form id="searchForm" name="searchForm" class="form-horizontal">
                 <div class="control-group">
				  <label for="searchServerId" class="control-label-6">交易流水号：</label> 
				  <span class="span3"> <input type="text" id="serialNo" maxlength="100" placeholder="交易流水号..."></span>
				  <label for="searchName" class="control-label-4">申请日期：</label> 
				  <span class="span3"> <input type="text" id="srcDate" maxlength="100" placeholder="申请日期..."></span>
				  
				  <label for="cifNo" class="control-label-4">模型名称：</label> 
				  <span class="span3"> <input type="text" id="modelName" maxlength="100" placeholder="模型名称..."></span>
 				  <label for="cifNo" class="control-label-4">客户名称：</label> 
	...
	<div id="grid-pager"></div>
			...
			<div id="ruleresultModal" class="modal hide fade" style="width:auto;margin-left: -23%;top:20px">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/countAnalysis/idpRejectRuleModel.js"></script>
