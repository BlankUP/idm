...
<body>
	<div class="container-fluid">
 	 <ul class="breadcrumb">
 		...
 		<li class="active"><i class="fa fa-list-alt"></i> 异常信息监控</li>
 	 </ul>
		<div class="alert alert-info">
            <form name="searchForm" class="form-horizontal">
            <div class="control-group">
            	<label for="searchProduct" class="control-label">产品名称 : </label> 
				 <span class="span3">
				  	<input type="text" id="searchProduct" maxlength="100" placeholder="请输入产品名称...">
				 </span>
	...
	<div id="exceptionSearch" class="modal hide fade" style="width: 725px;;margin-left: -23%;top:20px">
		<div class="modal-body" >
			<table id="exceptionSearch-table"></table>
			<div id="exceptionSearch-pager"></div>
		</div>
    ...
    <script src="resources/js/control/exceptionTransfer.js"></script>
</html>