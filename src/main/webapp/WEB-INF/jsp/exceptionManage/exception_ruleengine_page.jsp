...
<body>
 <div class="container-fluid">
	 ...
	 <ul class="nav nav-tabs" id="tab-menu">
		 <li><a href="#" onclick="gopage();">API异常数据</a></li>
		 <li><a href="#" class="active">决策异常数据</a></li>
	 </ul>
 ...
 <script type="text/javascript">
        ...
        function gopage() {
			location.href="<%=request.getContextPath()%>/exception_api_page";
        }
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datepicker.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/exceptionManage/exception_ruleengine_page.js"></script>
</body>
</html>