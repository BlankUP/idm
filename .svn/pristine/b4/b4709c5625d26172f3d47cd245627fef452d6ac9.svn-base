...
<body>
  ...
  <ul class="breadcrumb">
 			...
 			<li class="active"><i class="fa fa-cog"></i> 客户请求结果信息</li>
  </ul>
	<div class="alert alert-info">
            ...
            <div class="control-group">
				  ...
				  <label for="systemName" class="control-label-4">请求系统：</label> 
				  <span class="span3"> <select id="systemName" value="" style="width: 140px;">
						<option value="ECMS">线上贷款系统</option>
						<option value="MBSP">移动业务平台</option>
					</select></span>
...
<div id="slModal">	
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/countAnalysis/idpResponse.js"></script>
