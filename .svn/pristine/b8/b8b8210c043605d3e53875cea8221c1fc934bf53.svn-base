...
<body>
  <div class="container-fluid">	
	  <ul class="breadcrumb">
				...
				<li class="active"><i class="fa fa-list-alt"></i> 贷后催收模型数据统计</li>
	  </ul>
...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    <script src="<%=request.getContextPath()%>/resources/js/modelManage/modelMonitor/al_ays_data.js"></script>
