...
<body>
  <div class="container-fluid">	
	  <ul class="breadcrumb">
				...
				<li class="active"><i class="fa fa-list-alt"></i> 模型维度</li>
	  </ul>
	  <div class="alert alert-info">
		  <form name="searchForm" class="form-horizontal">
			  <div class="control-group">
				  ...
				  <label for="modelId" class="control-label">模型编码：</label>
				  <span class="span3">
						<input type="text" id="modelId" placeholder="请输入模型编码...">
				  </span>
...
<div class="row-fluid" style="margin-top:10px">
  ...
  <div class="row-fluid" style="margin-top:20px">
	  ...
	  <div style="width:48%;float: left;">
		  <div style="height:400px;weight: 1300px;" id="modeldimension"></div>
	  </div>
  </div>
<script type="text/javascript">
	...
	$(function(){
	    ...
	    <script src="resources/js/statisticalAnalysis/model_dimension.js"></script>
