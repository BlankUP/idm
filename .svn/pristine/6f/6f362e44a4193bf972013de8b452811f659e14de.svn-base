...
<body>
 <div class="container-fluid">
 	<ul class="breadcrumb">
		...
		<li> <i class="fa fa-globe"></i> 异常信息管理<span class="divider">/</span></li>
 		<li class="active"><i class="fa fa-list-alt"></i>模型质检系统异常信息</li>
	</ul>
			 ...
			 <div class="alert alert-info">
				 <form name="searchForm" class="form-horizontal">
					 <div class="control-group-yewu">
					  <label for="srcDate" class="control-label-6">业务请求日期：</label>
						 <span class="span3">
						...
						<input type="text" class="Wdate" id="srcDate" onfocus="new WdatePicker(this)" placeholder="请选择日期..." name="srcDate" />
						 ...
						 <label for="serialNo" class="control-label-5">请求流水号：</label>
						 <span class="span3">
							<input type="text" id="serialNo" placeholder="请输入流水号...">
						</span>
						 <span class="span2">
...
<div class="modal-body">
		<form id="dataFrom" class="form-horizontal">
		  ...
		  <tr><td>请求流水号</td><td><input id="serialNo2" type="text"  disabled="disabled"  name="serialNo"></td></tr>
 ...
 <script type="text/javascript">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/exceptionManage/mqi_exception_page.js"></script>
</body>
</html>