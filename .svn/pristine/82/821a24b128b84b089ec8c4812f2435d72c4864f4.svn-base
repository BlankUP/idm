	  ...
	  <div class="alert alert-info">
		  <form name="searchForm" class="form-horizontal">
			  <div class="control-group">
				  ...
				  <span class="span3">
						<input type="text" id="custName" placeholder="请输入客户名称...">
				</span>
			  ...
			  <div class="control-group">
				  ...
				  <span class="span3">
					<input type="text" id="custNo" placeholder="请输入客户号...">
				</span>
				  <span class="span2">
...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    <script src="<%=request.getContextPath()%>/resources/js/modelManage/indexMonitor/custIndexQuery.js"></script>
