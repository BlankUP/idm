 ...
 * @version 1.0
 */
public class MqiScoreRuleInfo implements Serializable {

	private static final long serialVersionUID = 1932497237535859148L;
	
	private String serialNo;  //交易节点流水号
	...
	public String toString() {
		return "MqiScoreRuleInfo [serialNo=" + serialNo + ", businessNo=" + businessNo + ", cifName=" + cifName
				+ ", idType=" + idType + ", idNo=" + idNo + ", deptId=" + deptId + ", deptName=" + deptName
				+ ", productId=" + productId + ", productName=" + productName + ", modelCode=" + modelCode
				+ ", modelName=" + modelName + ", ruleCode=" + ruleCode + ", ruleName=" + ruleName + ", ruleResult="
				+ ruleResult + ", score=" + score + ", initializationValue=" + initializationValue
				+ ", ruleSeverityLevel=" + ruleSeverityLevel + "]";
	}
