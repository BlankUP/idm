...
<body>
  ...
  <ul class="breadcrumb">
 			...
 			<li class="active"><i class="fa fa-list-alt"></i> 模型质检参数管理</li>
  </ul>
  </div>
	<div class="alert alert-info">
            ...
            <div class="control-group">
			  ...
			  <div class="moxingshangyou"><font class="moxingshangyou-font"> 模型质检参数管理</font></div>
			</form>
   ...
   <!-- 导入excel后，页面展示信息 -->
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/idpconfig/proModelParaConfig/modelQParaInfoConfig.js"></script>
