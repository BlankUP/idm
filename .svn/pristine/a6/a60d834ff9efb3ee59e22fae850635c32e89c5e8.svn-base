                ...
                if (typeof toolbar == "string") {
                    ...
                    for (var i = 0; i < toolbar.length; i++) {
                        ...
                        if (t == "-" ) {
                          ...
                          var tool = $("<button  class='btn-small'><i class='"+t.iconCls+"'></i> "+ t.text + "</button >").appendTo(BtnGroup);
...
$.jgrid.extend({
	...
	addRowData : function(rowid,rdata,pos,src) {
		if( "first".indexOf(pos) == -1 && "last".indexOf(pos) == -1 && "before".indexOf(pos) == -1 && "after".indexOf(pos) == -1) {pos = "last";}
