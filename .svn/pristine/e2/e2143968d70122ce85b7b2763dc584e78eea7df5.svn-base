	...
	public void csv() {
		...
		logger.info("*****文件存在机构状态修改成功*****");
				...
				String ftppath1 = ftppath+File.separator+date;
					...
					InputStream in = ftpUtils.getInputStreamByName(server, port1, username, password,"/home/weblogic/forms/batchFile/BRANCH_WITH_LEVEL/20190830", filename);
